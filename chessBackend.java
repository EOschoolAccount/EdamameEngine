public class chessBackend {
    ...
    private static void legalPawnMoves() {
        // Example: Move white pawns one step forward
        long oneStep = (wP >>> 8) & ~(wP | bP); // Shift pawns up and ensure no collisions
        wP = oneStep; // Update white pawns position
    }
